...
public class RecommendationController {
        ...
        public ApiResponse<List<RecommendationResponse>> getRecommendationsByCategory(
                        @CurrentUserId(required = false) Long userId,
                        @Parameter(description = "카테고리명 (경제/시사, 뷰티/패션 등, '기타' 제외)", example = "경제/시사") @RequestParam @NotBlank String category,
                ...
                if (linkCategory == LinkCategory.ETC) {
                        ...
                        recommendations = recommendationService.getRecommendationsByCategory(userId, etcKeywords, size);
                } else {
