...
public class RecommendationController implements RecommendationApi {
    ...
    public ApiResponse<List<RecommendationResponse>> searchByKeyword(
            ...
            int page,
            int size) {
        List<RecommendationResponse> searchResults = recommendationService.searchByKeyword(userId, keyword, page, size);
    ...
    public ApiResponse<List<RecommendationResponse>> getRecommendationsByCategory(
        ...
        if (category == null || category.isBlank()) {
            ...
            if (linkCategory == LinkCategory.ETC) {
                ...
                recommendations = recommendationService.getRecommendationsByCategory(userId, etcKeywords, page, size);
            } else {
                recommendations = recommendationService.getRecommendationsByCategory(userId, category, page, size);
            }
        }
