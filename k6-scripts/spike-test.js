...
export const options = {
  stages: [
    { duration: '10s', target: 5 },   // 워밍업: 0 → 5 VU
    { duration: '10s', target: 50 },   // 급격한 증가: 5 → 50 VU
    { duration: '30s', target: 50 },   // 유지: 50 VU
    { duration: '10s', target: 5 },    // 급격한 감소: 50 → 5 VU
    { duration: '30s', target: 5 },    // 회복 확인: 5 VU
  ],
  thresholds: {
